  ...
  return (
    <header className="sticky top-0 z-50 border-b bg-[#f4f4f400] backdrop-blur-lg border-blue-900/50">
      ...
      <div className={`md:hidden fixed inset-0 z-50 ${isMobileMenuOpen ? 'block' : 'hidden'}`}>
        {/* Backdrop */}
        <div className="fixed inset-0 bg-black bg-opacity-40" onClick={closeMobileMenu}></div>
        
        {/* Sidebar */}
        <div className="fixed top-0 right-0 w-64 h-full transition-transform duration-300 ease-in-out transform shadow-xl bg-gradient-to-b from-purple-900 to-slate-900">
